    ...
    <div class="col-md-10 right-aria-sldksd">
        <div class="content-body-dskd">
            ...
            <div class="find-people">
                <form action="{{ route('orgadmin.organisation.service.store', $org->id) }}" method="post"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @php
                                        $servicecat = App\Models\Servicecat::orderby('id', 'desc')
                                            ->where('status', 1)
                                            ->get();
                                    @endphp
                                    <!-- single Form Start-->
                                ...
                                <td>
                                    <div class="sigle-form-input-sddksldc0sd">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control"
                                                placeholder="Enter organization details" aria-label="Username"
                                                aria-describedby="basic-addon1" name="long_version">
                                        </div>
                                        @error('long_version')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
