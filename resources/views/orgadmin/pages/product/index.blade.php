        ...
        <div class="content-body-dskd">
            ...
            <div class="row">
                <div class="add-btn-new">
                    <a href="{{ route('orgadmin.organisation.product.create', $org->id) }}"
                                ...
                                @foreach ($product as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a
                                                href="{{ route('orgadmin.organisation.product.application.u.product', ['productslug' => $item->slug, 'id' => $org->slug]) }}">
                                        ...
                                        <td class="actiontable-dksld">
                                            ...
                                            @else
                                                <a href="{{ route('org.product.single', ['productslug' => $item->slug, 'slug' => $org->slug]) }}"
                                                    class="view-btn-table" target="_blank">View</a> <span>|</span> <a
                                                    href="{{ route('orgadmin.organisation.product.edit', ['productid' => $item->id, 'id' => $org->id]) }}"
