    ...
    <div class="col-md-10 right-aria-sldksd">
        <div class="content-body-dskd">
            ...
            <div class="find-people">
                ...
                <form
                    action="{{ route('orgadmin.organisation.sponsor.update', ['sponsorid' => $sponsor->id, 'id' => $org->id]) }}"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="sigle-form-input-sddksldc0sd">
                                        <div class="input-group mb-3">
                                            <textarea class="form-control" rows="3" name="sponsor_desc">{{ $sponsor->sponsor_desc }}</textarea>
                                        </div>
                                        @error('sponsor_desc')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="sigle-form-input-sddksldc0sd">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="file" class="form-control" aria-label="Username"
                                                aria-describedby="basic-addon1" name="logo">
                                        </div>
                                        @error('logo')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="sigle-form-input-sddksldc0sd">
                                        <div class="input-group mb-3">
                                            <input type="url" class="form-control" name="url" aria-label="Username"
                                                aria-describedby="basic-addon1" value="{{ $sponsor->sponsor_url }}">
                                        </div>
                                        @error('url')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
