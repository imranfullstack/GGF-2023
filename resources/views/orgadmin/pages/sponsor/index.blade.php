        ...
        <div class="content-body-dskd">
            ...
            <div class="row">
                <div class="add-btn-new">
                    <a href="{{ route('orgadmin.organisation.sponsor.create', $org->id) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">
                                            @if ($item->sponsor_logo)
                                                <img class="img-small-ds0d"
                                                    src="{{ asset('img/upload/sponsor/' . $item->sponsor_logo) }}"
                                                    width="100px"
                                                    style="
                                                      margin:10px;
                                                    ">
                                            @else
                                                <img class="img-small-ds0d" src="{{ asset('img/default.jpg') }}"
                                                    width="50px">
                                            @endif
                                        </td>
                                        ...
                                        <td class="actiontable-dksld">
                                            <a href="{{ route('orgadmin.organisation.sponsor.view', ['sponsorid' => $item->id, 'id' => $org->id]) }}"
                                                class="view-btn-table">View</a> <span>|</span> <a
                                                href="{{ route('orgadmin.organisation.sponsor.edit', ['sponsorid' => $item->id, 'id' => $org->id]) }}"
                                                class="view-btn-table">Edit</a>|</span> <a
                                                href="{{ route('orgadmin.organisation.sponsor.destroy', ['sponsorid' => $item->id, 'id' => $org->id]) }}"
                                                class="view-btn-table danger-skd">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
