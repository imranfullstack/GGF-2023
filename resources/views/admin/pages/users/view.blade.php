                            ...
                            <div class="col-md-3">
                                <div class="profile-sidebar">
                                    ...
                                    <div class="profile-userpic">
                                        ...
                                        @if ($user->image)
                                            <img src="{{ asset('img/upload/pic/' . $user->image) }}" class="img-responsive"
                                                alt="">
                                        @else
                                            <img src="https://www.nicepng.com/png/detail/136-1366211_group-of-10-guys-login-user-icon-png.png"
                                    ...
                                    <div class="profile-userbuttons">
                                        ...
                                        @if ($befound)
                                            <a target="_blank" class="btn btn-danger btn-sm"
                                                href="{{ asset('img/upload/resume/' . $befound->resume) }}">Download CV</a>
                                        @endif
                                    </div>
                                    <!-- END SIDEBAR BUTTONS -->
                                            ...
                                            @if ($join)
                                                @if ($join->organisation_id)
                                                    <div class="margin-top-20 profile-desc-link">
                                                        <i class="fa fa-globe"></i>
                                                        <a
                                                            href="https://www.apollowebstudio.com">{{ $join->organisation_id }}</a>
                                                    </div>
                                                @endif
                                            @endif
                                        </div>
                                    ...
                                    <div class="tableinfo">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row">Sur Name Status</th>
                                                    <td>
                                                        @if ($individual->surname_status == 1)
                                                            <span class="badge badge-green">Show</span>
                                                        @else
                                                            <span class="badge badge-danger">hide</span>
                                                        @endif
                                                ...
                                                <tr>
                                                    <th scope="row">Ecommerce Status</th>
                                                    <td>
                                                        @if ($individual->ecommerce_status == 1)
                                                            <span class="badge badge-green">Show</span>
                                                        @else
                                                            <span class="badge badge-danger">hide</span>
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $individual->other_info }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Other Info Status</th>
                                                    <td>
                                                        @if ($individual->other_info_status == 1)
                                                            <span class="badge badge-green">Show</span>
                                                        @else
                                                            <span class="badge badge-danger">hide</span>
                                                        @endif
...
@if($join)                                    
                                    <div class="tableinfo">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row">JOIN ANY ORGANISATION</th>
                                                    <td>
                                                            @if ($join->organisation_id)
...
@php
  $org = App\Models\Organisation::where('id',$join->organisation_id)->first();
@endphp                                                
                                                <tr>
