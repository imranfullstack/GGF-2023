...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><b> Key Skills </b></li>
  </ol>
</nav>
<hr>
...
<form action="{{route('admin.keyskill.store')}}" method="post">
	@csrf
	<!-- Modal -->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="exampleModalLabel">Add New Focus Keyword </h5>
...
<form action="{{route('admin.keyskill.update',$item->id)}}" method="post">
	@csrf
	      <div class="modal-body">
