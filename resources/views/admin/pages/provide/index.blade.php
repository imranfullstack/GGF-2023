...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><b> provide </b></li>
  </ol>
</nav>
<hr>
...
<form action="{{route('admin.provide.store')}}" method="post">
	@csrf
	<!-- Modal -->
...
<form action="{{route('admin.provide.update',$item->id)}}" method="post">
	@csrf
	      <div class="modal-body">
