...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><b> Focus</b></li>
  </ol>
</nav>
<hr>
...
<form action="{{route('admin.focus.store')}}" method="post">
	@csrf
	<!-- Modal -->
...
<form action="{{route('admin.focus.update',$item->id)}}" method="post">
	@csrf
	      <div class="modal-body">
