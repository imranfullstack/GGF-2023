                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-select" name="status" disabled>
                                        <option value="0" {{ $order->status == 0 ? 'selected' : '' }}>Pendding
                                        </option>
                                        <option value="2" {{ $order->status == 2 ? 'selected' : '' }}>Contacted
                                        </option>
                                        <option value="1" {{ $order->status == 1 ? 'selected' : '' }}>Approve
                                        </option>
                                        <option value="3" {{ $order->status == 3 ? 'selected' : '' }}>Closed
                                        </option>
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th colspan="2">
                                    ...
                                    <a href="{{ route('admin.service.application', $order->service_id) }}"
