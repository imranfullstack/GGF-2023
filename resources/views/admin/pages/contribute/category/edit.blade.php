...
<br>
	...
	<section class="form-aria56d-section">
		<div class="container-fluid">
			...
			<form method="post" action="{{route('admin.contribute.category.update',$cat->id)}}">
				@csrf
					<div class="form-dlsdkc">
						<input type="text" name="name" class="form-control" placeholder="Enter Category" required value="{{$cat->name}}">
