...
@section('main_content')
    ...
    <form method="get" action="{{ route('filter.event.filtter') }}" class="checkboxes">
            ...
            <div class="modal-dialog modal-dialog modal-xl">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><span class="bdl-skdlc">Search: </span>
                            EXPERIENCES & EVENTS</h5>
            ...
            <div class="modal-dialog modal-dialog modal-xl">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><span>SEARCH:</span> PROJECT</h5>
                ...
                <div class="nav-left-dksld-search">
                    ...
                    @else
                        <div class="no-found-message">
                            ...
                            <h1 class="text-danger">Sorry No EXPERIENCES & EVENTS Found</h1>
                        </div>
                    @endif
                        ...
                        @if ($org)
                            {
                                ...
                                desc: '{{ Str::limit($item->short_desc, 150, $end = '...') }}',
                                url: '{{ route('org.event.single', ['eventslug' => $item->slug, 'slug' => $org->slug]) }}',
                                tags: ['tourism_01'],
                                lat: {{ $item->lat }},
                                lng: {{ $item->long }},
                                img: '{{ asset('img/upload/event/' . $item->image) }}',
                                phone: '{{ $item->contact_phone }}',
                                icon: 'http://127.0.0.1:8000/frontend/images/icons/map.png'
                            },
                        @else
                        @endif
                    @endforeach
