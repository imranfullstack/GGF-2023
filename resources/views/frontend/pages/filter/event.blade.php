                    ...
                    <div class="col-md-4">
                        ...
                        <div class="button-top-search">
                            ...
                            <div class="btn-group search-dark">
                              ...
                              <button  class="btn btn-danger" ype="button" data-bs-toggle="modal" data-bs-target="#exampleModa66">Projects</button>
            ...
            <div id="sidebar-wrapper">
                ...
                <div class="nav-left-dksld-search">
                    ...
                    <div id="activmap-places" class="hidden-xs">
                        ...
                        <h2 class="result-cound-skdsdf">Results - {{$event->count()}}</h2>
