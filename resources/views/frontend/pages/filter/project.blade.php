...
button.btn-dark-dd , a.btn.btn-danger.btn-dark-dd  {
...
.right-side-content-aria-map .date {
...
.date span.saparator-date-address {
...
@php 
    ...
    $structure = App\Models\Ogranisationtype::orderby('id','desc')->where('status',1)->get();
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="button-top-search">
                            ...
                            <div class="btn-group search-dark">
                              ...
                              <button  class="btn btn-danger " ype="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Organisations</button>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="button-top-search">
                            ...
                            <div class="btn-group ">
                              ...
                              <button  class="btn btn-danger" ype="button" data-bs-toggle="modal" data-bs-target="#exampleModal55">Expriences / Events</button>
...
<script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyDjS5QXqKr4vDPLOTUwFcmn8oDSjQIawNc'></script>
    ...
    <script src="{{asset('frontend/js/event-activemap.js')}}"></script>
...
@endphp
                    ...
                    {title: '{{$item->name}}', address: '{{$item->location}}', date: '{{ Carbon\Carbon::parse($item->date)->format('d M Y') }} ', desc: '{{Str::limit($item->short_desc, 150, $end='...')}}', url: '{{route('org.project.single',['projectslug'=>$item->slug,'slug'=>$org->slug])}}', tags: ['tourism_01'], lat:{{$item->lat}}, lng: {{$item->long}}, img: '{{asset('img/upload/project/'.$item->image)}}', phone:'{{$item->contact_phone}}' ,  icon: 'http://127.0.0.1:8000/frontend/images/icons/map.png'},
