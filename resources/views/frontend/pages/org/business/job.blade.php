@if ($org->hiring == 1)
    @php
        $recruits = App\Models\Recruit::orderby('id', 'desc')
    ...
    <div class="job-position-dksld0c">
        ...
        <div class="title-dkdksldkfdf2 bg-dksld">
            ...
            {{-- Body Section Start --}}
            <div class="accordion-collapse collapse" id="jobsddsd">
                <div class="tab-body-dksld">
                    ...
                    <div class="job-position-items">
                        @foreach ($recruits as $item)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="content-box-ddks">
                                            <h4>{{ $item->title }}</h4>
                                            <p>{{ Str::limit($item->short_desc, 120, $end = '...') }}</p>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel">POSITION:
                                                {{ $item->title }}</h5>
                            ...
                            <div class="modal fade  " id="job_popup_apply_{{ $item->id }}"
                                data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                aria-labelledby="job_popup_apply_{{ $item->id }}" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
