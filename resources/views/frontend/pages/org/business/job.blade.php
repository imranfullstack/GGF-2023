...
@if($org->hiring == 1) 
@php 
  $recruits = App\Models\Recruit::orderby('id','desc')->where('organisation_id',$org->id)->limit(3)->get();
@endphp
...
<div class="col-md-12">
	<div class="read-more-section right">
		<a href="{{route('org.recruit.index',$org->slug)}}" class="btn-green apply-btn-style-dksld">More Jobs</a>
	</div>
</div>
