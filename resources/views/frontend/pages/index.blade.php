...
@foreach($event as $item)
              ...
              <tr>
                ...
                <td>
                  ...
                  {{ Carbon\Carbon::parse($item->start_date)->format('d M Y') }} <b>-</b> {{ Carbon\Carbon::parse($item->end_date)->format('d M Y') }} </td>

                <td><a href="{{route('org.index',$item->organisation->slug)}}" class="link-table">{{$item->organisation->org_name}}</a></td>





                <td><a href="{{route('org.event.single',['eventslug'=>$item->slug,'slug'=>$item->organisation->slug])}}" class="btn btn-green">More</a></td>
