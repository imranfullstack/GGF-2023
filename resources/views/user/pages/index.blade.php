...
@php 
	...
	$project = App\Models\Projectapply::orderby('id','desc')->where('user_id',Auth::user()->id)->get();
	$jobs = App\Models\Jobapply::orderby('id','desc')->where('user_id',Auth::user()->id)->get();
	$event = App\Models\Eventapply::orderby('id','desc')->where('user_id',Auth::user()->id)->get();
	$product = App\Models\Productbuy::orderby('id','desc')->where('user_id',Auth::user()->id)->get();
	$service = App\Models\Serviceapply::orderby('id','desc')->where('user_id',Auth::user()->id)->get();
        ...
        <div class="first-collaps-part">
          <div class="service-aria-business-dkskdf0c23d">
            <div class="title-dkdksldkfdf2 bg-dksld">
              <a data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" class="first-title-dksld0c collapsed"> DASHBOARD <span>
            ...
            <div class="tab-body-dksld">
              <div class=" col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <br>
                    <a href="{{route('user.profile')}}" class="btn btn-green btn-block"> EDIT PROFILE</a>
                  </div>
                </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="first-collaps-part">
          <div class="service-aria-business-dkskdf0c23d">
            <div class="title-dkdksldkfdf2 bg-dksld">
              <a data-bs-toggle="collapse" href="#projecttabs-d03d" role="button" aria-expanded="false" aria-controls="collapseExample" class="first-title-dksld0c"> PROJECTS <b> ( {{$project->count()}} )</b> <span>
                  <i class="fas fa-caret-down"></i>
                </span>
              </a>
            </div>
...
@foreach($project as $item)								
							  <tr>
							    <td>{{$i++}}</td>
							    <td><img src="{{asset('img/upload/project/'.$item->project->image)}}" width="50px"></td>
							    <td class="eventname"><b>{{$item->project->name}}</b></td>
							    <td><a href="{{route('org.index',$item->project->organisation->slug)}}" class="link-table">{{$item->project->organisation->org_name}}</a></td>
							    <td>
							     {{ Carbon\Carbon::parse($item->project->start_date)->format('d/m/y') }} - {{ Carbon\Carbon::parse($item->project->end_date)->format('d/m/y') }} 
                  </td>
                ...
                <td>
                  ...
                  @endif
							    ...
							    <td>
							    	<a href="{{route('user.project.single.project',$item->id)}}" class="btn btn-green">
							    		<i class="fa fa-eye"></i>
							   		 </a>
								</td>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="first-collaps-part">
          <div class="service-aria-business-dkskdf0c23d">
            <div class="title-dkdksldkfdf2 bg-dksld">
              <a data-bs-toggle="collapse" href="#jobscollups" role="button" aria-expanded="false" aria-controls="collapseExample" class="first-title-dksld0c"> JOBS <b>( {{$jobs->count()}} )</b><span>
                  <i class="fas fa-caret-down"></i>
                </span>
              </a>
            </div>
...
@foreach($jobs as $item)
							  ...
							  <tr>
							    <td>{{$i++}}</td>
							    <td><img src="{{asset('img/upload/org/logo/'.$item->job->organisation->logo)}}" width="30px"></td>
							    <td class="eventname"><b>{{$item->job->title}}</b></td>
							    <td> {{$item->created_at->format('d M Y')}} </td>
							    <td><a href="{{route('org.index',$item->job->organisation->slug)}}" class="link-table">{{$item->job->organisation->org_name}}</a></td>
                ...
                <td>
                  ...
                  @endif
							    ...
							    <td><a href="{{route('user.recruit.single.recruit',$item->id)}}" class="btn btn-green">More</a></td>
							  </tr>
@endforeach							  
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="first-collaps-part">
          <div class="service-aria-business-dkskdf0c23d">
            <div class="title-dkdksldkfdf2 bg-dksld">
              <a data-bs-toggle="collapse" href="#eventtabs-sldk" role="button" aria-expanded="false" aria-controls="collapseExample" class="first-title-dksld0c"> EVENTS <b>( {{$event->count()}} )</b><span>
                  <i class="fas fa-caret-down"></i>
                </span>
              </a>
            </div>
...
@php $i = 1; @endphp
				@foreach($event as $item)						
							  <tr>
							    ...
							    <td class="eventname"><b>{{$item->event->event_name}}</b></td>
							    <td>{{ Carbon\Carbon::parse($item->event->date)->format('d M Y') }}
							    </td>

							    <td><a href="{{route('org.index',$item->event->organisation->slug)}}" class="link-table">{{$item->event->organisation->org_name}}</a></td>
                ...
                <td>
                  ...
                  @endif
							    ...
							    <td><a href="{{route('user.event.single.event',$item->id)}}" class="btn btn-green">More</a></td>
							  </tr>
				@endforeach			
							</tbody>
						</table>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="first-collaps-part">
          <div class="service-aria-business-dkskdf0c23d">
            <div class="title-dkdksldkfdf2 bg-dksld">
              <a data-bs-toggle="collapse" href="#products-sldk" role="button" aria-expanded="false" aria-controls="collapseExample" class="first-title-dksld0c"> Products <b>( {{$product->count()}} )</b><span>
                  <i class="fas fa-caret-down"></i>
                </span>
              </a>
            </div>
            ...
            <div class="tab-body-dksld">
              <div class="col-md-12">
                  ...
                  <td>{{ Carbon\Carbon::parse($item->created_at)->format('d M Y') }}</td>
							    <td><img src="{{asset('img/upload/product/'.$item->product->thumbnail)}}" width="50px"></td>
							    <td class="eventname"><b>{{$item->product->name}}</b></td>
							    <td>{{$item->status}} </td>
                ...
                <td>
                  ...
                  @endif
							    ...
							    <td><a href="{{route('user.product.single.product',$item->id)}}" class="btn btn-green">More</a></td>
							  </tr>
						@endforeach							  
							</tbody>
						</table>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="first-collaps-part">
          <div class="service-aria-business-dkskdf0c23d">
            <div class="title-dkdksldkfdf2 bg-dksld">
              <a data-bs-toggle="collapse" href="#services-sldk" role="button" aria-expanded="false" aria-controls="collapseExample" class="first-title-dksld0c"> Services <b>( {{$service->count()}} )</b><span>
                  <i class="fas fa-caret-down"></i>
                </span>
              </a>
            </div>
          ...
          <div class="collapse" id="services-sldk">
			...
			@foreach($service as $item)								
							  <tr>
							    <td>{{$i++}}</td>
							    <td><img src="{{asset('img/upload/service/'.$item->service->image)}}" width="50px"></td>
							    <td class="eventname"><b>{{$item->service->name}}</b></td>
							    <td>{{ Carbon\Carbon::parse($item->service->available_date)->format('d M Y') }} </td>
							    <td><a href="{{route('org.index',$item->service->organisation->slug)}}" class="link-table">{{ $item->service->organisation->org_name }}</a></td>
                ...
                <td>
                  ...
                  @endif
							    ...
							    <td><a href="{{route('user.service.single.service',$item->id)}}" class="btn btn-green">More</a></td>
							  </tr>
			@endforeach					
							</tbody>
						</table>
