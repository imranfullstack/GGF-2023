...
<tbody>
              ...
              <!-- single Form -->
              <tr>
                <th scope="row" width="50%">Service Name</th>
                <td>
              ...
              <tr>
                ...
                <td>
                  <b>
                  {{$service->service->organisation->org_name}}
                </b>
                </td>
              </tr>
              <!-- single Form End-->
              ...
              <tr>
                ...
                <td>
                  {{$service->preferred_start_time}}
                </td>
              </tr>
              <tr>
                <th>Preferred Completion Date</th>
                <td>
                  {{$service->preferred_completion_date}}
                </td>
              </tr>
              <tr>
                <th>Preferred Completion time</th>
                <td>
                  {{$service->preferred_completion_time}}
                </td>
              </tr>
              <tr>
