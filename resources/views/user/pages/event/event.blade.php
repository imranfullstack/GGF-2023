  ...
  <div class="container">
    <section>
      <div class="container">
      	<br>
      	<div class="row">
      		<h2 style="text-align: center;text-transform: uppercase;">event Information</h2>
      	</div>
...
<table class="table">
            ...
            <tbody>
              <!-- single Form -->
              <tr>
                <th scope="row" width="50%">Event Name</th>
                <td>
              ...
              <!-- single Form End-->
              <tr>
                <th scope="row" width="50%">Organisation Name</th>
                <td>
                  <b>
                  {{$event->event->organisation->org_name}}
                </b>
                </td>
              </tr>
              <!-- single Form End-->
              <!-- single Form -->
              <tr>
                <th scope="row" width="50%">Your Name</th>
                <td>
                  {{$event->name}}
                </td>
              </tr>
...
<div class="row">
	<div class="col-md-6">
		<a href="" class="btn btn-green btn-block">View event</a>
	</div>
	<div class="col-md-6">
