...
@section('style')
    ...
    <style type="text/css">
        ...
        <style type="text/css">a.first-title-dksld0c {
            font-size: 29px;
            margin: 0;
            padding: 0;
            text-decoration: none;
                    ...
                    <div class="row">
                        <div class="table-body">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ Carbon\Carbon::parse($recruit->available_from)->format('d M Y') }}
                                        </td>
                                    </tr>
                                    <!-- single Form End-->
                                    <!-- single Form -->
                                    <tr>
                                        ...
                                        <td>
                                            {{ Carbon\Carbon::parse($recruit->available_until)->format('d M Y') }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('user.index') }}" class="btn btn-green btn-block">Back To
                                        Dashboard</a>
                                </div>
                            </div>
                        </div>
