...
<tbody>
              ...
              <tr>
                ...
                <td>
                	{{$product->product->price * $product->quantity}} AUD
                </td>
              </tr>
...
<div class="row">
	<div class="col-md-6">
		<a href="{{route('org.product.single',['productslug'=>$product->product->slug,'slug'=>$product->product->organisation->slug])}}" class="btn btn-green btn-block">View Product</a>
	</div>
	<div class="col-md-6">
