        ...
        activmap: function(settings) {
            ...
            s.showPanel ? ("left" == s.posPanel && (activmap_places.css({
                ...
                if ($.each(s.places, function(e, a) {
                        ...
                        }), n.setVisible(!1), a.marker = n, markers.push(n), a.html = '<div class="activmap-place" id="activmap-place_' + e + '"> <div class="row"><div class="col-md-3"><div class="image-map"><img src='+a.img+'></div></div><div class="col-md-9"><div class="right-side-content-aria-map"><h4 class="title-dsdd">'+a.title+'</h4><div class="date">'+a.date+'<span class="saparator-date-address">/</span>'+a.address+'</div><p class="map-desc">'+ a.desc + '</p> <a href="'+ a.url +'" class="btn btn-map-btn" target="_blank">More</a></div></div></div></div>', $.each(a.tags, function(e, t) {
